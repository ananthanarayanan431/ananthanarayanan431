...
def main():
    ...
    rows = [
        ("OS", "Linux / macOS"),
        ("Role", "Product Engineer, GenAI / Agents"),
        ("Host", "Oraczen, Hyderabad"),
        ("Editor", "VS Code"),
        ("", ""),
        ...
        ("", ""),
        ("Currently", "promptly, finance-advisory-agent"),
        ("Exploring", "Agent evals, voice agents, MCP / A2A"),
        ("", ""),
        ("Public Repos", "85"),
        ("Top Starred", "Langchain-Projects-LLM (100+)"),
        ("", ""),
        ("Email", "me@ananthanarayanan.com"),
        ("Website", "ananthanarayanan.com"),
